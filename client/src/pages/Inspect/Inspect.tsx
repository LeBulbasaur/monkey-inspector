...
function Inspect(props: Props): JSX.Element {
  ...
  const [monkeyHabitat, setMonkeyHabitat] = useState<string>(
    props.id === 1
      ? data.monkeys[props.id - 1].habitat
      : props.id === 2
      ? data.monkeys[props.id - 1].habitat
      : props.id === 3
      ? data.monkeys[props.id - 1].habitat
    ...
    <>
      <div className="inspect__main">
        ...
        <div className="inspect__content">
          ...
          <div className="inspect__canvas__data__container">
